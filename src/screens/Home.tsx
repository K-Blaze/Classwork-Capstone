...
const products = [
  { img: "IMG_20260622_062404(1).jpg", name: "Anx — Anxiety + Tension", desc: "May relieve symptoms of anxiety and tension. Doctor formulated.", price: "$42.00" },
  { img: "IMG_20260622_062404.png", name: "Ins — Insomnia", desc: "May relieve sleeplessness caused by anxiety, restlessness, or stress.", price: "$42.00" },
  { img: "IMG_20260622_062357(1).jpg", name: "Mp — Menopause", desc: "May relieve hot flashes and hormonal imbalance. With Black Cohosh.", price: "$42.00" },
  { img: "IMG_20260622_062352(1).jpg", name: "BpS — Back Pain + Sciatica", desc: "Homeopathic relief for back pain and sciatica symptoms.", price: "$42.00" },
  { img: "IMG_20260622_062352.png", name: "Pain Relief", desc: "Natural homeopathic pain relief. Doctor formulated.", price: "$42.00" },
  { img: "IMG_20260622_062336(1).jpg", name: "TH — Tension Headache", desc: "May relieve tension headache symptoms naturally.", price: "$42.00" },
];
    ...
    <div>
      ...
      <div style={styles.founderSection}>
        <div style={styles.founderInner}>
          <img src={BASE + "IMG_20260622_062348(1).jpg"} alt="K-Blaze founder" style={styles.founderImg} />
      ...
      <div style={styles.shopSection}>
        ...
        <div style={styles.salonRow}>
          ...
          <img src={BASE + "IMG_20260622_062348(1).jpg"} alt="K-Blaze with products" style={styles.salonImg} />
        </div>
        ...
        <div style={styles.braidingBox}>
          ...
          <div style={styles.braidingText}>
            ...
            <a href="tel:319-COBB-EYE" style={styles.shopBtn}>Book Now</a>
          </div>
        </div>
...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  founderImg: { width: "200px", height: "200px", objectFit: "cover" as const, borderRadius: "12px", border: "2px solid #ff1493" },
  founderText: { flex: 1, minWidth: "200px" },
  founderTitle: { color: "#ff1493", fontSize: "20px", fontWeight: "bold", marginBottom: "0.75rem" },
