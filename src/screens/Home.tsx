...
const products = [
  ...
  { img: "IMG_20260622_062352(1).jpg", name: "Ins — Insomnia", desc: "May relieve sleeplessness caused by anxiety, restlessness, or stress.", price: "$42.00" },
    ...
    <div>
      ...
      <div style={styles.shopSection}>
        ...
        <div style={styles.salonRow}>
          ...
          <img src={BASE + "IMG_20260622_062412(1).png"} alt="What's inside our sprays" style={styles.salonImg} />
          <img src={BASE + "IMG_20260622_062348(1).jpg"} alt="Pink mason jars" style={styles.salonImg} />
        </div>
